  ...
  const SidePanel = () => {
    ...
    return (
      <div id="app-sidepanel">
        ...
        <h3 className="text-medium">Your Cards</h3>
        ...
        <h3 className="text-medium">Recent Transations</h3>
        {transactions_list}
            ...
            <div className="dashboard-container">
              <div className="dashboard-item">
                ...
                <div className="text-large">
                  <span className="text-small">£ </span>28,642.33
                </div>
                <div className="chart-container">
                  <table class="charts-css line app-chart" id="chart1">
                    <tbody>
                      ...
                      <tr>
                        <td style={{ "--start": 0.6, "--size": 0.8 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.8, "--size": 0.8 }}></td>
                      </tr>
                      <tr>
                ...
                <div className="chart-container">
                  <table class="charts-css line app-chart" id="chart2">
                    <tbody>
                      ...
                      <tr>
                        <td style={{ "--start": 0.0, "--size": 0.5 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.5, "--size": 0.3 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.3, "--size": 0.2 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.2, "--size": 0.8 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.8, "--size": 0.6 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.6, "--size": 0.5 }}></td>
                      </tr>
                    </tbody>
                  </table>
                  <div className="chart-overlay"></div>
                ...
                <div className="chart-container">
                  <table class="charts-css line app-chart" id="chart3">
                    <tbody>
                      ...
                      <tr>
                        <td style={{ "--start": 0.4, "--size": 0.4 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.4, "--size": 0.7 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.7, "--size": 0.8 }}></td>
                      </tr>
                      <tr>
                        <td style={{ "--start": 0.8, "--size": 1.0 }}></td>
                      </tr>
                    </tbody>
                  </table>
                  <div className="chart-overlay"></div>
          ...
          <div className="flex-row dashboard-row-large">
            <div className="dashboard-container dashboard-container-large">
              <div className="dashboard-item flex-column">
                ...
                <table
                  id="chart4"
                  className="charts-css line multiple hide-data show-labels"
                >
                  ...
                  <tbody>
                    <tr>
                      <th scope="row" className="text-small">
                        {" "}
                        2000{" "}
                      </th>{" "}
                ...
                <div className="dashboard-item">
                  ...
                  <div className="flex-column">
                    <div className="profit-item flex-row text-medium">
                      <i className="fa fa-arrow-up success"></i>
                      <span>
                        <span className="text-small">£</span>6,969.45
                        <div className="text-small">Income</div>
                      </span>
                    </div>
                    <div className="profit-item flex-row text-medium">
                      <i className="fa fa-arrow-down alert"></i>
                      <span>
                        <span className="text-small">£</span>420.12
                        <div className="text-small">Expenses</div>
                      </span>
                    </div>
                  </div>
                </div>
    ...
    return (
      <div id="app-nav">
        <div className="flex-center">
          <img
            id="logo"
            src="https://image.flaticon.com/icons/png/512/187/187902.png"
          ></img>
        </div>
        <div>{nav}</div>
      </div>
